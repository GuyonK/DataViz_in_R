...
Death_in_NL%>%
  ...
  coord_flip()+
  labs(y = NULL, x = NULL)+#<<
  ggtitle("Number of people died yearly in NL (1995 - 2021)")#<<
```
]
.pull-right[
...
Death_in_NL%>%
  ...
  scale_color_manual(values = c("#ef8a62", "#67a9cf"))+ 
  theme_classic()+
  labs(x = NULL, y = "Number of people died in NL (1995 - 2021)")+#<<
  theme(axis.text = element_text(size = 12),
        title = element_text(size = 14),
        strip.background = element_blank(), 
        strip.text = element_text(size = 14),
...
1. Build a plot to analyze how the number of deaths from external causes (not a disease) has been changed over past years. </br>
1. Study the differences between men and women. Is there statistically significant difference?</br> 

You will need these data to answer the quiz in the brightspace.</br>
<img src="figs/quiz.png" width="100px" align = 'right'>

1. Adjust the style and design of the plot making it visually appealing.
