...
1. Plot 1 from the slide 14 demonstrates distributions in the number of deceased per year over the period from 1996 till 2021. And *dot plot* is not the best geom to demonstrate distributions. Modify the plot using the geoms that fit better for the task (see lecture 1_5_geometries).

2. Plot from the slide 17 looks good enough, although the amounts for many lines are not recognizable. Can you visualize the number of deceased from different causes of deaths for a particular year (2015).

3. Plot from the slide 26 shows the progression in the number of deceased over time. It uses the total number of deceased irrespective of the age. Make a new plot to visualize the number of deceased men and women depending on the age, make it for a particular year (2015) and for a particular cause of death (Neoplasms). 
