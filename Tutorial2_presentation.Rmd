...
1) What is an age profile of the number of deaths from external causes (not a disease) in NL? Is there any differences between man and women?

2) How the number of perinatal deaths in NL changed over time?

You will need these plots to answer the quiz in the brightspace (to be done after Tutorial 3).
